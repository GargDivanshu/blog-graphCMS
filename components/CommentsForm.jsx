  ...
  return (
    <div className="bg-white shadow-lg p-8 pb-12 mb-8">
        ...
        <div className="grid grid-cols-1 gap-4 mb-4">
           <textarea 
           value={formData.comment} onChange={onInputChange}
        ...
        <input
            type="text" value={formData.name} onChange={onInputChange}
            className="py-2 px-4 outline-none w-full rounded-lg focus:ring-2 focus:ring-gray-100 text-gray-700"
            placeholder="Name"
            name="name"            
        />
        <input
            type="text" value={formData.email} onChange={onInputChange}
            className="py-2 px-4 outline-none w-full rounded-lg focus:ring-2 focus:ring-gray-100 text-gray-700"
            placeholder="Email"
            name="email"            
        />
        ...
        <div className="grid grid-cols-1 gap-4 mb-4">
            <div>
                ...
                htmlFor="storeData"
                >Save my email & number for the next time i comment</label>
            </div>
        </div>
        {error && 
